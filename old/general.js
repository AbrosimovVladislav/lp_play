...
const activityDetails = {
  run: {
    ...
    paragraphs: [
      "Можно прийти без подписки, чтобы познакомиться. Стартуем на набережной у Калемегдана, бежим до Галерии и обратно — около 5 км.",
  "После идём в кафе: пробежка — скорее повод собраться, поговорить и спокойно познакомиться с девчонками из клуба.",
  "Темпом не меряемся и рекордов не ждём. Если можешь легко бежать и хочешь познакомиться — этого достаточно."
    ],
    facts: [
      ["Темп", "разговорный"],
  ...
  saturday: {
    ...
    paragraphs: [
     "Это не ночной клуб и не обязательное afterparty. Просто лёгкий дневной формат: можно зайти на час или остаться дольше, если пошло.",
"Иногда это DJ-сет во дворе кофейни, иногда бранч, иногда музыка и разговоры после недели. Формат специально живой, без расписания ради расписания.",
