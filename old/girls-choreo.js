...
const activityDetails = {
  run: {
    image: "assets/images/women-club-run.png",
    alt: "Женская беговая группа бежит вдоль реки утром",
    kicker: "Каждое воскресенье · 9:00",
    title: "Воскресный бег по набережной",
    lead: "Лёгкий разговорный темп для тех, кто хочет движения между choreo-тренировками.",
    paragraphs: [
  ...
  saturday: {
    image: "assets/images/girls-choreo-cafe-after.png",
    alt: "Девушки из клуба общаются, танцуют и пьют кофе на дневной встрече",
    kicker: "Суббота · старт в 13:00",
    title: "Girls Party",
    lead: "Дневная встреча для комьюнити: DJ, кофе, лимонады и люди, с которыми ты уже пересекалась на тренировках.",
    paragraphs: [
  ...
  stretch: {
    image: "assets/images/women-club-stretch.png",
    alt: "Девушки делают растяжку в парке после тренировки",
    kicker: "Парк · мягкий темп",
    title: "Растяжка в парке",
    lead: "Спокойная растяжка на траве, чтобы снять забитость мышц после танцев и разгрузить голову после рабочей недели.",
    paragraphs: [
  ...
  recovery: {
    image: "assets/images/women-club-recovery.png",
    alt: "Девушки отдыхают в зоне рекавери после нагрузки",
