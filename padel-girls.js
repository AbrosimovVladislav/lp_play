...
const activityDetails = {
  ...
  saturday: {
    ...
    alt: "Дневная встреча клуба в кофейне с DJ, танцами, кофе и лимонадами",
    kicker: "Суббота · старт в 13:00",
    title: "Вечеринка в субботу",
    lead: "Дневная встреча без алкоголя: DJ, танцы, кофе, лимонады и безопасная атмосфера для знакомств.",
    paragraphs: [
      "Это не деловой нетворкинг с бейджами и не обязательное afterparty. Просто лёгкий дневной формат, куда можно зайти на час или остаться дольше, если стало хорошо.",
      ...
      "Можно прийти одной: вокруг уже будут знакомые лица из игр, пробежек и чата, а дальше обычно появляются разговоры, планы и новые подруги.",
    ],
    facts: [
      ["Когда", "суббота, 13:00"],
  ...
  stretch: {
    ...
    alt: "Девушки делают растяжку в парке после спорта",
    ...
    paragraphs: [
      ...
      "Можно прийти после игры, после пробежки или просто потому что хочется чуть больше движения без корта. Всё идёт в комфортном темпе, без давления и сравнений.",
  ...
  recovery: {
    ...
    paragraphs: [
      ...
      "Это история для тех, кто играл, бегал или просто устал от недели. Приходишь без спортивной задачи: погреться, выдохнуть и побыть рядом с девчонками из клуба.",
      "Формат появляется в чате отдельным анонсом. Если откликается — бронируешь место, если нет — спокойно пропускаешь. В PlayUp Girls нет обязательных посещений.",
    ],
    facts: [
