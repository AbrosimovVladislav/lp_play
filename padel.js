...
const activityDetails = {
  run: {
    ...
    paragraphs: [
      "Можно прийти без подписки: познакомиться и пробежать с нами. Старт у Калемегдана, круг до Галерии и обратно — около 5 км.",
  ...
  saturday: {
    ...
    paragraphs: [
      ...
      "Можно прийти одному: рядом уже будут знакомые лица из игр, пробежек и чата.",
    ],
    facts: [
      ["Когда", "суббота, 13:00"],
  ...
  stretch: {
    ...
    lead: "Спокойная растяжка на траве после игр, пробежек и недели.",
    paragraphs: [
      "Собираемся в парке, берём коврики и делаем простую мобильность: спина, ноги, плечи, дыхание.",
      "Можно прийти после игры, пробежки или просто ради движения без корта. Всё идёт в мягком темпе.",
  ...
  recovery: {
    ...
    paragraphs: [
      ...
      "Для тех, кто играл, бегал или просто устал от недели. Приходишь без задачи: погреться, выдохнуть и побыть с клубом.",
