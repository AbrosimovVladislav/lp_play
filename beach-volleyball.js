...
const activityDetails = {
  run: {
    ...
    lead: "Лёгкий разговорный темп для тех, кто хочет движения между играми на песке.",
    paragraphs: [
  ...
  saturday: {
    ...
    alt: "Субботняя вечеринка клуба с DJ, напитками и людьми из волейбольных групп",
  ...
  stretch: {
    ...
    lead: "Спокойная растяжка на траве, чтобы снять забитость мышц после игр на песке и просто разгрузить голову после рабочей недели.",
    paragraphs: [
  ...
  recovery: {
    ...
    title: "Рекавери",
    lead: "Хаммам, джакузи и спокойный разговор вместо ещё одной партии.",
    paragraphs: [
